...
async function getData() {
    const response = await fetch(
        'https://www.highcharts.com/samples/data/olympic2012.json' // Canviar això si es volen unes dades propies (simplement retornar la ruta del fitxer JSON que té les dades)
    );
